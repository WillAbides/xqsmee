...
func (*Header) Descriptor() ([]byte, []int) {
	return fileDescriptor_queue_e12eac5ec581e769, []int{0}
}
...
type WebRequest struct {
	ReceivedAt           int64     `protobuf:"varint,1,opt,name=ReceivedAt,proto3" json:"ReceivedAt,omitempty"`
...
func (*WebRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_queue_e12eac5ec581e769, []int{1}
}
...
func (*PopRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_queue_e12eac5ec581e769, []int{2}
}
...
func (*PopResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_queue_e12eac5ec581e769, []int{3}
}
...
func (*PeekRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_queue_e12eac5ec581e769, []int{4}
}
...
func (*PeekResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_queue_e12eac5ec581e769, []int{5}
}
...
func init() { proto.RegisterFile("queue.proto", fileDescriptor_queue_e12eac5ec581e769) }

var fileDescriptor_queue_e12eac5ec581e769 = []byte{
	// 315 bytes of a gzipped FileDescriptorProto
	,
}
